...
-- Note: You'll need to update this with a proper bcrypt hash
INSERT INTO users (email, name, role, status, password_hash) VALUES 
('admin@lawfirm.com', 'System Administrator', 'admin', 'approved', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi');

-- Insert sample attorneys
INSERT INTO users (email, name, role, status, password_hash) VALUES 
('john.doe@lawfirm.com', 'John Doe', 'attorney', 'approved', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi'),
('jane.smith@lawfirm.com', 'Jane Smith', 'attorney', 'approved', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi');
...
(1, 1, 'Preliminary Hearing', 'Prepare for preliminary hearing in ABC Corp case', '2024-02-15 09:00:00+00'),
(2, 2, 'Document Review', 'Review medical reports for personal injury case', '2024-02-10 14:00:00+00');
